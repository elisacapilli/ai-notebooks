...
## Notebooks inclusi
### '10_stats_Gemma' (10 Statements con Gemma)
Seleziona 10 affermazioni a caso dal dataset e le passa al modello **Gemma 2B**.  
Estrae:
- `statement_text` – testo dell’affermazione  
- `fact_check_ground_truth_value` – valore di veridicità

### '10_stats_Mistral' (10 Statements con Mistral)
Stesso procedimento di '10_stats_Gemma', ma con il modello **Mistral 7B**.

### '1_stat_Gemma' (1 Statement + 5 valutazioni con Gemma)
Valuta una singola affermazione usando 5 punteggi ottenuti da crowdsourcing.

### '1_stat_Mistral' (1 Statement + 5 valutazioni con Mistral)
Stesso procedimento di '1_stat_Gemma', ma con il modello **Mistral 7B**.
